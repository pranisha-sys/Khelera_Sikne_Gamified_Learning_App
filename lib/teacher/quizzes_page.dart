  ...
  Future<void> _saveQuizToFirebase() async {
    ...
    try {
      ...
      await quizRef.set({
        ...
        'teacherId': user.uid, // For QuizzesPage compatibility
        'assignedBy': user.uid, // For TeacherQuizzesPage compatibility
        'questionCount': _questions.length,
        'studentCount': 0, // For TeacherQuizzesPage compatibility
        'totalStudents': 0, // For QuizzesPage compatibility
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: ElevatedButton(
                              onPressed: _isSaving ? null : _saveQuizToFirebase,
                              style: ElevatedButton.styleFrom(
                                backgroundColor: const Color(0xFF10B981),
                                padding:
                                    const EdgeInsets.symmetric(vertical: 16),
